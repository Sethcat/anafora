...
RelationFrame.prototype.updateCurrentRelationValue = function() {
	console.log('RelationFrame.updateCurrentRelationValue');
	_setting.has_fullfill = true;
	...
	if(this.selectedRelationRow != undefined) {
		...
		console.log('oldRow', this.selectedRelationRow);
...
RelationFrame.prototype.searchRowFromRelation = function(relation) {
	...
	console.log('prototype searchRowFromRelation.rRow', rRow);
	return rRow;
}
