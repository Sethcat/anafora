...
urlpatterns = patterns('',
    ...
    #url(r'^annotate/(?P<projectName>[^\/]+)/(?P<corpusName>[^\/]+)/(?P<taskName>[^\/]+)/(?P<schema>[^\/]+)/onebyone/$', 'annotate.views.index_onebyone', name='display1by1'), 
    #url(r'^testme/$', views.testme, name='testme'),
    #url(r'^testonebyone/$', views.test_onebyone,),
    url(r'^sentenceonebyone/$', views.getAnaforaXMLFile_onebyone),    
